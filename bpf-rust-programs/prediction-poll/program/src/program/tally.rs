...
pub fn record_wager(tally: &mut TallyData, user_pubkey: &SolPubkey, wager: u64) -> ProgramResult<()> {
...
pub fn payout(tally: &TallyData, accounts: &mut [SolKeyedAccount], winning_quantity: u64, pot: u64) -> ProgramResult<()> {
